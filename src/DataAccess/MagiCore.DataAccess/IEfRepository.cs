    ...
    where TKey : IEquatable<TKey>
{
    ...
    bool IsPropertiesModified(TEntity entity, string property, params string[] properties);
    ...
    Task<bool> IsPropertiesModifiedAsync(TEntity entity, string property, params string[] properties);
}