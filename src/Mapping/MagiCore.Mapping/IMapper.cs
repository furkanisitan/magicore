...
public interface IMapper
{
    ...
    /// <summary>
    /// Execute a mapping from the source object to a new destination object with explicit <see cref="Type" /> objects.
    /// </summary>
    /// <param name="source">Source object to map from.</param>
    ...
    /// <summary>
    /// Execute a mapping from the source object to existing destination object with explicit <see cref="Type" /> objects.
    /// </summary>
    /// <param name="source">Source object to map from.</param>
    /// <param name="destination">Destination object to map into.</param>
    /// <param name="sourceType">Source type to use.</param>
